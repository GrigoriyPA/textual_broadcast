    ...
    def __handler(self):
        ...
        def on_message(message):
            ...
            if from_id != author_id:
                ...
                self.compute_massage(Message((from_id, "TG"), text, author_id, chat_name=chat_name, is_owner=is_owner, photos=photo))
            else:
                self.compute_massage(Message((from_id, "TG"), text, author_id, photos=photo))
